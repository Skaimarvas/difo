...
const ProgressBar = () => {
  return (
    <div className="flex flex-col lg:w-[400px] w-[600px] sm:w-[320px] mx-auto">
      ...
      <div className="flex justify-center relative bg-black">
        ...
        <div className="absolute left-0 p-[14px] justify-center h-5 sm:w-[90px] lg:w-[120px] w-[150px] bg-gradient-to-r from-[#AB00FF] to-[#FFAC00] rounded-xl"></div>
        <div className="absolute left-[160px] lg:left-[130px] sm:left-[100px] top-[2px]">
