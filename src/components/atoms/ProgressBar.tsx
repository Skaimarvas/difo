...
const ProgressBar = () => {
  return (
    <div className="flex flex-col lg:w-[370px] md:w-[580px] w-[600px] sm:w-[320px] mx-auto">
      ...
      <div className="flex justify-center relative bg-black">
        ...
        <div className="absolute left-0 p-[14px] justify-center h-5 sm:w-[90px] md:w-[160px] lg:w-[100px] w-[150px] bg-gradient-to-r from-[#AB00FF] to-[#FFAC00] rounded-xl"></div>
        <div className="absolute left-[160px] lg:left-[110px] md:left-[170px]  sm:left-[100px] top-[2px]">
